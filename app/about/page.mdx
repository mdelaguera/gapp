export const metadata = {
  ...
  description: 'Learn about our mission to help players find their perfect pickleball paddle through comprehensive reviews and unbiased recommendations.',
  keywords: ['about us', 'pickleball paddle reviews', 'review methodology', 'team']
}

# About Get A Pickleball Paddle

Welcome to Get A Pickleball Paddle - your trusted source for comprehensive paddle reviews and buying guidance in the fastest-growing sport in America.
...
- **Review validation** from trusted industry sources
...
Our reviews are conducted by experienced players and analysts with backgrounds in:
- **Tournament competition** (3.0 to 5.0+ skill levels)
- **Coaching and instruction** (certified instructors)
