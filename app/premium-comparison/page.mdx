export const metadata = {
  ...
  description: 'Comprehensive comparison of the top 4 premium pickleball paddles in 2025. Detailed analysis of JOOLA Ben Johns, CRBN Genesis, Selkirk VANGUARD, and Engage Pursuit Pro.',
  keywords: ['premium pickleball paddles', 'JOOLA Ben Johns Perseus', 'CRBN Genesis', 'Selkirk VANGUARD', 'Engage Pursuit Pro', 'paddle comparison', 'tournament paddles']
}
...
![Selkirk VANGUARD Power Air Epic - Maximum Power Pickleball Paddle](/img/paddles/selkirk-vanguard-power-air-epic.svg)
